...
class AddSearchHistoryUseCase @Inject constructor(private val searchHistoryRepository: SearchHistoryRepository) {

    operator fun invoke(searchHistoryEntity: SearchHistoryEntity) {
        searchHistoryRepository.addSearchHistory(searchHistoryEntity)
    }
}